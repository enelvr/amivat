...
<input type="hidden" id="plantel" name="plantel" value="<?php echo $datos; ?>"><input type="number" min="1" max="20" id="equipon" name="equipon" onKeyUp="this.value=this.value.toUpperCase();">
	...
	<td>
		<input class="equipoope" type="number" min="0" max="20" id="equipoope" name="equipoope" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
</tr>
<tr>
	<td>
	...
	<td>
		<input class="equipoino" type="number" min="0" max="20" id="equipoino" name="equipoino" onKeyUp="this.value=this.value.toUpperCase();" required>	</td>
	<td>
		CUENTA CON INTERNET:
	</td>
	<td>
...
<tr>
	...
	<td>
	<input class="mesasexistente" type="number" min="0" max="20" id="mesasexistente" name="mesasexistente" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
	<td>
	MESAS OPERATIVAS
	</td>
	<td>
	<input class="mesasbuena" type="number" min="0" max="20" id="mesasbuena" name="mesasbuena" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
</tr>
<tr>
	<td>
	...
	<td>
		<input class="mesasmala" type="number" min="0" max="20" id="mesasmala" name="mesasmala" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
	<td>
	MESAS NECESARIAS:
	</td>
	<td><input class="mesasnec" type="number" id="mesasnec" name="mesasnec" min="0" max="20" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
</tr>
<tr>
	<td>
	...
	<td>
	<input class="nsillas" type="number" min="0" max="20" id="nsillas" name="nsillas" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
	<td>
	SILLAS OPERATIVAS:
	</td>
	<td>
	<input class="sillasbuen" type="number" min="0" max="20" id="sillasbuen" name="sillasbuen" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
</tr>
<tr>
	<td>
	...
	<td>
	<input class="sillasmalas" type="number" min="0" max="20" id="sillasmalas" name="sillasmalas" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
	<td>
	SILLAS NECESARIAS:
	</td>
	<td>
	<input class="sillasnecesarias" type="number" min="0" max="20" id="sillasnecesarias" name="sillasnecesarias" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
</tr>
<tr>
	<td>
...
<tr>
	...
	<td>
	<input class="airesbuenos" type="number" min="0" max="6" id="airesbuenos" name="airesbuenos" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
	<td>
	AIRES INOPERATIVOS:
	</td>
	<td>
	<input class="airesrep" type="number" min="0" max="6" id="airesrep" name="airesrep" onKeyUp="this.value=this.value.toUpperCase();" required>
	</td>
</tr>
<tr>
<td>
